/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 38a3c0138dacb54ae961ea239bf70d54)
// Runtime types generated with workerd@1.20260828.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	SOP_BUCKET: R2Bucket;
	DIRECTORY_BUCKET: R2Bucket;
	...
	USAGE_BUDGET: DurableObjectNamespace<import("./src/server").UsageBudget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatAgent" | "UsageBudget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MONTHLY_MESSAGE_BUDGET" | "AI_GATEWAY_ID" | "RETRIEVAL_QUERY_REWRITE" | "RETRIEVAL_MAX_RESULTS" | "RETRIEVAL_KEYWORD_MATCH">> {}
}
